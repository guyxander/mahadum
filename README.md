...
Copy `.env.example` to `.env.local` and add local values there. Environment files are ignored by Git. Never commit Supabase secret/service-role keys, Flutterwave secrets, webhook secrets, passwords, or private keys.
