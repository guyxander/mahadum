alter table public.creator_profiles rename column flutterwave_subaccount_id to paystack_subaccount_code;
alter table public.payments alter column provider set default 'paystack';
alter table public.payout_accounts alter column provider set default 'paystack';
alter table public.payout_accounts rename column encrypted_account_token to provider_recipient_code;

update public.payments set provider='paystack' where provider='flutterwave' and status='pending';
update public.payout_accounts set provider='paystack' where provider='flutterwave';
